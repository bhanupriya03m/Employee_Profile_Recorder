...
//     if (department && dob && gender && designation && salary) {
//       const formData = {
//         id: new URLSearchParams(window.location.search).get("empId"),
//         name: new URLSearchParams(window.location.search).get("employeeName"),
//         department,
//         dob,
//         gender,
//         designation,
